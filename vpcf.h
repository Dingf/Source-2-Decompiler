...
/* VPCF_C File Format
   ...
   DATA Block
	 ...
	 12 bytes:  Bounding box min (float x3)
	 12 bytes:  Bounding box max (float x3)
	 ...
	 4 bytes:   Color (TODO: Figure out the format, it's definitely argb something)
	 ...
	 12 bytes:  Default CP1 offset to CP0 (float x3)
